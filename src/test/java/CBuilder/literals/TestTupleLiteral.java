...
public class TestTupleLiteral {
    ...
    private static Stream<Arguments> sources_expression(){
        return Stream.of(
            Arguments.of(List.of(new IntLiteral(1)), "__mpy_tuple_assign(0, __mpy_obj_init_int(1), __mpy_obj_init_tuple(1))"),
            Arguments.of(List.of(new IntLiteral(1), new IntLiteral(2), new IntLiteral(3)), "__mpy_tuple_assign(0, __mpy_obj_init_int(1), __mpy_tuple_assign(1, __mpy_obj_init_int(2), __mpy_tuple_assign(2, __mpy_obj_init_int(3), __mpy_obj_init_tuple(3))))"),
            Arguments.of(List.of(new StringLiteral("Test1"), new StringLiteral("Test2")), "__mpy_tuple_assign(0, __mpy_obj_init_str_static(\"Test1\"), __mpy_tuple_assign(1, __mpy_obj_init_str_static(\"Test2\"), __mpy_obj_init_tuple(2)))")
        );
    }

    private static Stream<Arguments> sources_statement(){
        return Stream.of(
            Arguments.of(List.of(new IntLiteral(1)), "__mpy_obj_ref_dec(__mpy_tuple_assign(0, __mpy_obj_init_int(1), __mpy_obj_init_tuple(1)));\n"),
