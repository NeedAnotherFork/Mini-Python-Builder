...
public class TestAttributeReference {
    ...
    private static Stream<Arguments> sources_build_expression(){
        return Stream.of(
            Arguments.of("referenceName", new IntLiteral(23), "__mpy_obj_get_attr(__mpy_obj_init_int(23), \"referenceName\")"),
    ...
    private static Stream<Arguments> sources_build_object(){
        return Stream.of(
            ...
            Arguments.of("referenceName1", new BoolLiteral(true), "__mpy_obj_init_boolean(true)"),
            Arguments.of("referenceName2", new StringLiteral("stringL"), "__mpy_obj_init_str_static(\"stringL\")")
        );
    }
