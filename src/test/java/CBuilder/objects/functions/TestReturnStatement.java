...
public class TestReturnStatement {
    ...
    private static Stream<Arguments> sources(){
        return Stream.of(
            Arguments.of( new IntLiteral(34), "retValue = __mpy_obj_init_int(34);\n" +
                "goto ret;\n"),
            Arguments.of( new BoolLiteral(true), "retValue = __mpy_obj_init_boolean(true);\n" +
                "goto ret;\n"),
            Arguments.of( new StringLiteral("34"), "retValue = __mpy_obj_init_str_static(\"34\");\n" +
                "goto ret;\n")
        );
    }
