...
public class TestFunction {
    ...
    void build_cfunction(String funcName, List<Statement> body, List<Argument> positionalArgs, List<VariableDeclaration> localVariables, String expected){
    ...
    void build_func_object_declaration(String funcName, List<Statement> body, List<Argument> positionalArgs, List<VariableDeclaration> localVariables, String expected){
        Function function = new Function(funcName,body,positionalArgs,localVariables);
    ...
    void build_initialisation(String funcName, List<Statement> body, List<Argument> positionalArgs, List<VariableDeclaration> localVariables, String expected){
        Function function = new Function(funcName,body,positionalArgs,localVariables);
    ...
    void build_refdec(String funcName, List<Statement> body, List<Argument> positionalArgs, List<VariableDeclaration> localVariables, String expected){
        Function function = new Function(funcName,body,positionalArgs,localVariables);
    ...
    void build_expression(String funcName, List<Statement> body, List<Argument> positionalArgs, List<VariableDeclaration> localVariables, String expected){
        Function function = new Function(funcName,body,positionalArgs,localVariables);
    ...
    void get_name(String funcName, List<Statement> body, List<Argument> positionalArgs, List<VariableDeclaration> localVariables, String expected){
        Function function = new Function(funcName,body,positionalArgs,localVariables);
    ...
    private static Stream<Arguments> sources_build_cfunction() {
        return Stream.of(
            Arguments.of("funcName1",
                List.of(new Call(new AttributeReference("__add__", new IntLiteral(1)), List.of(new Expression[]{new IntLiteral(3)}))),
                List.of(new Argument("argName1", 0), new Argument("argName2", 1)),
                List.of(new VariableDeclaration("local1"), new VariableDeclaration("local2")),
