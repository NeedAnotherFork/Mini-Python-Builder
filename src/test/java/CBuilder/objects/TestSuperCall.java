...
public class TestSuperCall {
    ...
    private static Stream<Arguments> sources_expression(){
        return Stream.of(
            Arguments.of( List.of(new Expression[]{
                new IntLiteral(23)
            }), "__mpy_call(__mpy_super, __mpy_tuple_assign(0, self, __mpy_tuple_assign(1, __mpy_obj_init_int(23), __mpy_obj_init_tuple(2))), NULL)"),
            Arguments.of( List.of(new Expression[]{
                new BoolLiteral(true)
            }), "__mpy_call(__mpy_super, __mpy_tuple_assign(0, self, __mpy_tuple_assign(1, __mpy_obj_init_boolean(true), __mpy_obj_init_tuple(2))), NULL)")
        );
    }
    ...
    private static Stream<Arguments> sources_statement(){
        return Stream.of(
            Arguments.of( List.of(new Expression[]{
                new IntLiteral(23)
            }), "__mpy_obj_ref_dec(__mpy_call(__mpy_super, __mpy_tuple_assign(0, self, __mpy_tuple_assign(1, __mpy_obj_init_int(23), __mpy_obj_init_tuple(2))), NULL));\n"),
            Arguments.of( List.of(new Expression[]{
                new BoolLiteral(true)
            }), "__mpy_obj_ref_dec(__mpy_call(__mpy_super, __mpy_tuple_assign(0, self, __mpy_tuple_assign(1, __mpy_obj_init_boolean(true), __mpy_obj_init_tuple(2))), NULL));\n")
        );
    }
