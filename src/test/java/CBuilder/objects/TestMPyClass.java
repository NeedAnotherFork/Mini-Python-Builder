...
public class TestMPyClass {
    ...
    void build_declaration(String name, Reference parent, List<Function> functions, Map<Reference, Expression> classAttributes, String expected){
    ...
    void build_initialisation(String name, Reference parent, List<Function> functions, Map<Reference, Expression> classAttributes, String expected){
        MPyClass mpyC = new MPyClass(name, parent, functions, classAttributes);
    ...
    void build_refdec(String name, Reference parent, List<Function> functions, Map<Reference, Expression> classAttributes, String expected){
        MPyClass mpyC = new MPyClass(name, parent, functions, classAttributes);
    ...
    void build_expression(String name, Reference parent, List<Function> functions, Map<Reference, Expression> classAttributes, String expected){
        MPyClass mpyC = new MPyClass(name,parent, functions, classAttributes);
    ...
    void build_statement(String name, Reference parent, List<Function> functions, Map<Reference, Expression> classAttributes, String expected){
        MPyClass mpyC = new MPyClass(name, parent, functions, classAttributes);
    ...
    private static Stream<Arguments> sources_build_declaration(){
        return Stream.of(
            Arguments.of("MyClass1",new Reference("__MPyType_Object"), List.of(new Function[]{
                new Function("__init__", List.of(new Statement[]{
                    new SuperCall(List.of())
                }), List.of(new Argument[]{
                    new Argument("self", 0)
                }), List.of())
            }), new HashMap<>(),"__MPyObj *MyClass1;\n" +
                ...
                "}\n"),
            Arguments.of("MyClass2",new Reference("MyClass1"), List.of(new Function[]{
                new Function("__init__", List.of(new Statement[]{
                    new SuperCall(List.of())
                }), List.of(new Argument[]{
                    new Argument("self", 0)
                }), List.of())
            }), new HashMap<>(),"__MPyObj *MyClass2;\n" +
    ...
    private static Stream<Arguments> sources_build_initialisation(){
        return Stream.of(
            ...
            }), new HashMap<>(),"MyClass1 = __mpy_obj_init_type(\"MyClass1\", __MPyType_Object);\n" +
            ...
            }), new HashMap<>(),"MyClass2 = __mpy_obj_init_type(\"MyClass2\", MyClass1);\n" +
    ...
    private static Stream<Arguments> sources_build_refdec(){
        return Stream.of(
            ...
            }), new HashMap<>(),"__mpy_obj_ref_dec(MyClass1);\n"),
            Arguments.of("MyClass2",new Reference("MyClass1"), List.of(new Function[]{
                new Function("__init__", List.of(new Statement[]{
                    new SuperCall(List.of())
                }), List.of(new Argument[]{
            ...
            }), new HashMap<>(),"__mpy_obj_ref_dec(MyClass2);\n")
        );
    }
