...
public class TestCall {
    ...
    private static Stream<Arguments> sources_build_expression(){
        return Stream.of(
            Arguments.of(new Reference("print"), List.of(new Expression[]{
                new IntLiteral(23)
            }), "__mpy_call(print, __mpy_tuple_assign(0, __mpy_obj_init_int(23), __mpy_obj_init_tuple(1)), NULL)"),
            Arguments.of(new Reference("type"), List.of(new Expression[]{
                new IntLiteral(23)
            }), "__mpy_call(type, __mpy_tuple_assign(0, __mpy_obj_init_int(23), __mpy_obj_init_tuple(1)), NULL)")
        );
    }
    ...
    private static Stream<Arguments> sources_build_statement(){
        return Stream.of(
            Arguments.of(new Reference("print"), List.of(new Expression[]{
                new IntLiteral(23)
            }), "__mpy_obj_ref_dec(__mpy_call(print, __mpy_tuple_assign(0, __mpy_obj_init_int(23), __mpy_obj_init_tuple(1)), NULL));\n"),
            Arguments.of(new Reference("type"), List.of(new Expression[]{
                new IntLiteral(23)
            }), "__mpy_obj_ref_dec(__mpy_call(type, __mpy_tuple_assign(0, __mpy_obj_init_int(23), __mpy_obj_init_tuple(1)), NULL));\n")
        );
    }
