...
public class TestWhileStatement {
    ...
    private static Stream<Arguments> sources_build(){
        return Stream.of(
            Arguments.of(new BoolLiteral(true), List.of(), "while (__mpy_boolean_raw(__mpy_call(__mpy_obj_get_attr(__mpy_obj_init_boolean(true), \"__bool__\"), __mpy_obj_init_tuple(0), NULL))) {\n" +
                "}"),
            Arguments.of(new BoolLiteral(true), List.of(new Call(new AttributeReference("__add__", new IntLiteral(1)), List.of(new Expression[]{new IntLiteral(3)}))), "while (__mpy_boolean_raw(__mpy_call(__mpy_obj_get_attr(__mpy_obj_init_boolean(true), \"__bool__\"), __mpy_obj_init_tuple(0), NULL))) {\n" +
                ...
                "}"),
            Arguments.of(new BoolLiteral(false), List.of(new Call(new AttributeReference("__add__", new IntLiteral(1)), List.of(new Expression[]{new IntLiteral(3)}))), "while (__mpy_boolean_raw(__mpy_call(__mpy_obj_get_attr(__mpy_obj_init_boolean(false), \"__bool__\"), __mpy_obj_init_tuple(0), NULL))) {\n" +
                "\t__mpy_obj_ref_dec(__mpy_call(__mpy_obj_get_attr(__mpy_obj_init_int(1), \"__add__\"), __mpy_tuple_assign(0, __mpy_obj_init_int(3), __mpy_obj_init_tuple(1)), NULL));\n" +
                "}"),
            Arguments.of(new Call(new AttributeReference("__gt__", new Reference("a")), List.of(new Expression[]{new IntLiteral(1)})),
                List.of(new Call(new Reference("print"), List.of(new Expression[]{
                    new Reference("a")
                })), new Assignment(new Reference("a"),new Call(new AttributeReference("__sub__", new Reference("a")), List.of(new Expression[]{new IntLiteral(1)})))),
