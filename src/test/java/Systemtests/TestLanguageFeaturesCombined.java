...
//         call each built-in function in a nested context to make sure it correctly implements refCounts
        ...
        builder.addClass(new MPyClass("ClassB", new Reference("__MPyType_Object"), List.of(new Function[]{
        ...
        builder.addClass(new MPyClass("C", new Reference("ClassB"), List.of(new Function[]{
            new Function("__init__", List.of(new Statement[]{
                new SuperCall(List.of())
            }), List.of(new Argument[]{
                new Argument("self", 0)
        ...
        builder.addStatement(new Assignment(new Reference("bObj"), new Call(new Reference("ClassB"), List.of())));
