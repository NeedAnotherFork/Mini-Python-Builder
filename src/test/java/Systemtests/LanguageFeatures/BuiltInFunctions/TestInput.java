...
public class TestInput {
    ...
    void input(String input, String expected, @TempDir Path workDirectory) throws IOException, InterruptedException {
        String result = "";
    ...
    void input_timeout(@TempDir Path workDirectory) throws IOException, InterruptedException {
        ...
        assertTimeoutPreemptively(Duration.ofSeconds(5), ()-> getProgramOutputBasedOnInput(workDirectory,result,input));
    }
